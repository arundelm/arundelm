...
🎲 **Social Wagering App** — building a wagering platform with friends. More on this soon.

🎮 **[Refinr](https://github.com/arundelm/refinr-game)** — Severance-themed web game that collects RLHF training data by having players label AI response pairs through an eerie corporate drag-and-drop interface, mirroring Macrodata Refinement.
